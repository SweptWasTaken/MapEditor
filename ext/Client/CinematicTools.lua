...
-- Copied from CinematicTools/ext/Client/__init__.lua

function CinematicTools:__init()
	print("Initializing CinematicTools")
	self:RegisterVars()
end

function CinematicTools:RegisterVars()
    -- Cinematic Tools vars
...
function CinematicTools:OnSetKeyboard(p_Value)
...
function CinematicTools:OnLoaded()
...
function CinematicTools:OnUpdateInput(p_Delta, p_SimulationDelta)
...
function CinematicTools:LoadPreset(p_Preset, p_LerpTime)
...
function CinematicTools:RemovePreset(p_PresetName, p_LerpTime)
...
function CinematicTools:UpdateLerp(p_Delta)

end

function CinematicTools:LoadPresets(p_LerpTime)
...
function CinematicTools:FixEnvironmentState(p_State)
...
function CinematicTools:SendState(p_Class, p_State, p_TypeInfo)
...
function CinematicTools:SendValue(p_Class, p_Field, p_Type, p_Value)
...
function CinematicTools:CreateData(p_DataName)
...
function CinematicTools:SendEnum(p_Enum)
	local s_Enum = ""
...
function CinematicTools:OnUpdateValue(p_Contents, p_LerpTime)
