...
-- Replaced CinematicToolsClient with MapEditorClient --
-- Copied from CinematicTools/ext/Client/__init__.lua
-- TODO: Place the following logic in a dedicated class file, which can be imported into this file as seen above
